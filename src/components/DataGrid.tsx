...
const DataCard: React.FC<{
  ...
  date: string;
  comments: number;
}> = ({ imgUrl, title, description, date, comments }) => {
  return (
    <Box className="rounded overflow-hidden shadow-lg flex flex-col">
      ...
      <Box className="relative">
        ...
        <Link to="#!">
          <Box className="text-xs absolute top-0 right-0 bg-indigo-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
            Cooking
          </Box>
        </Link>
      </Box>
      <Box className="px-6 py-4 mb-auto">
        <Link to="#" className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">
          {title}
        </Link>
  ...
  return (
    <Box maxWidth="md" className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        <Typography 
            ...
            >
                ...
                <span>
                    <Typography 
                        variant="h1" 
                        className="text-yellow-300 topic inline" 
                    >
                        rockets
                    </Typography>{" "}
                </span>
      ...
      <Box className="border-b mb-5 flex justify-between text-sm">
        <Box className="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
        {/* <svg className="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.005 455.005" xmlSpace="preserve" enableBackground="new 0 0 455.005 455.005">
            <g>
      ...
      <Box className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        <DataCard
          imgUrl="https://images.pexels.com/photos/61180/pexels-photo-61180.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500"
        ...
        />
        <DataCard
          imgUrl="https://images.pexels.com/photos/1600727/pexels-photo-1600727.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500"
        ...
        />
        <DataCard
          imgUrl="https://images.pexels.com/photos/6086/food-salad-healthy-vegetables.jpg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500"
